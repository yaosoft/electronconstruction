...
<div id="page-wrapper">
    ...
    <div id="footer">
        ...
        <ul class="icons">
            ...
            <li><a  target="_blank" href="https://server200.serverange.net:2096/cpsess0151966654/3rdparty/roundcube/?_task=mail&_mbox=INBOX" title="Messagerie @electron-construction.ga" class="icon"><img src='images/mail.png'></a></li>
        </ul>
